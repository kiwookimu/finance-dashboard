...
function buildStockRecommendationCondition(
  ...
  return {
    ...
    confirmationGuard:
      ...
      `setup score >= ${criteriaNumber(criteria, "confirmedSetupScore", 75)}, ${rollingWindowDays}-day return <= ${maxConfirmedRollingReturn}%, high drawdown within -${maxConfirmedHighDrawdown}%, and no overheat or weak-market downgrade`,
